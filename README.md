...
BE*Go* is a lightweight rules library written in Golang to simplify the building of Event Drive Ractiven Applications. Supports Declaritive Rules, Contextual reasoning across time and space
