...
import (
	...
	"github.com/project-flogo/rules/examples/flogo/creditcard/test"
	"github.com/project-flogo/rules/ruleapi/tests"

	"github.com/stretchr/testify/assert"
)

func TestCreditCardKeyDB(t *testing.T) {
	command := exec.Command("docker", "run", "-p", "6381:6379", "-d", "eqalpha/keydb")
